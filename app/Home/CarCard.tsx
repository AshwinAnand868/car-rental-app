...
function CarCard({car}: CarProps) {
    return car && (
        <div className='group bg-gray-50 p-2 sm:p-5 rounded-3xl m-1 sm:m-5 
            hover:bg-white hover:border-[1px] cursor-pointer duration-75 border-blue-500'>
            <h2 className='text-[20px]
            font-medium mb-2'>{car.name}</h2>
            ...
            <div className='flex justify-around group-hover:hidden'>
                <div className='text-center text-gray-500'>
                    <PiSteeringWheelFill className='w-full text-[20px] mb-2' />
                    <h2 className='text-[14px] font-light'>{car?.carType}</h2>
                </div>
                <div className='text-center text-gray-500'>
                    <MdAirlineSeatReclineNormal className='w-full text-[22px] mb-2' />
                    <h2 className='text-[14px] font-light'>{car?.noOfSeats}</h2>
                </div>
                <div className=' text-center text-gray-500 '>
            ...
            from-blue-400 to blue-700 p-2 rounded-lg text-white 
